    ...
    return (
        <div className='w-full px-6 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6'>
            {productData.map(
                ...
                <div key={_id} className='w-full bg-yellow-300 text-black p-4 border border-gray-300 rounded-lg group overflow-hidden'>
                    ...
                    >
                        <Image className='w-full h-full object-cover scale-90 hover:scale-100 transition-transform duration-300' width={300} height={300} src={image} alt='ProductImg'/>
                        </Link>
                    ...
                    <div className='px-4 py-3 flex flex-col gap-1'>
                        ...
                        } className='h-10 font-medium bg-amazon_blue text-white rounded-md hover:bg-red-600 hover:text-black duration-300 mt-2'>add to cart</button>
                    </div>
                </div>
            ))}
        </div>
