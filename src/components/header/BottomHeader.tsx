...
const BottomHeader = () => {
  ...
  return (
    <div className="w-full h-10 bg-red-400 text-sm text-white px-4 flex items-center">
        ...
        {
          userInfo && (
            <button onClick={handleSignOut} className="hidden md:inline-flex  items-center h-8 px-12  border border-transparent text-amazon_yellow hover:border-red-600 hover:text-red-600 cursor-pointer duration-300">Sign Out</button>
          )
        }
    </div>
  )
