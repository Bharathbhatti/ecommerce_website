...
const CartProduct = ({item}:cartProductsProps) => {
  ...
  return (
    <div className='bg-gray-100 rounded-lg flex items-center gap-4'>
        <Image className='object-cover' width={150} height={150} src={item.image} alt='ProductImg'/>
        <div className='flex items-center px-2 gap-4'>
          <div className=' flex flex-col gap-1'>
            ...
            <div className='flex items-center gap-6'>
              ...
              <div onClick={()=>dispatch(deleteProduct(item._id))} className='flex items-center text-sm text-gray-400 font-medium hover:text-red-600 cursor-pointer duration-300'>
